...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aF, request.ao, true);
		} catch (e) {
...
var $author$project$Presentations$Model = $elm$core$Basics$identity;
var $elm$core$Maybe$Nothing = {$: 1};
var $author$project$Presentations$Received = $elm$core$Basics$identity;
var $elm$core$Basics$apL = F2(
	function (f, x) {
		return f(x);
	});
var $author$project$Presentation$Presentation = $elm$core$Basics$identity;
...
var $author$project$Presentation$decoder = function () {
	var construct = F2(
		function (presentationName, presentationUrl) {
			return {W: presentationName, ao: presentationUrl};
		});
	return A3(
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {Q: fragment, T: host, Y: path, _: port_, ad: protocol, ae: query};
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{au: false, aw: r.aw, aA: r.aA, R: r.R, aF: r.aF, aP: r.aP, an: r.an, ao: r.ao}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{aw: $elm$http$Http$emptyBody, aA: r.aA, R: _List_Nil, aF: 'GET', aP: $elm$core$Maybe$Nothing, an: $elm$core$Maybe$Nothing, ao: r.ao});
};
var $elm$json$Json$Decode$list = _Json_decodeList;
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Presentations$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$none;
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Presentations$update = F2(
	function (msg, _v0) {
		var model = _v0;
		if (msg.$ === 1) {
			var error = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						aa: $elm$core$Maybe$Just(error)
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			var presentations = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{G: presentations}),
...
var $author$project$Presentation$name = function (_v0) {
	var presentation = _v0;
	return presentation.W;
};
var $elm$virtual_dom$VirtualDom$text = _VirtualDom_text;
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $elm$html$Html$ul = _VirtualDom_node('ul');
var $author$project$Presentation$url = function (_v0) {
	var presentation = _v0;
	return presentation.ao;
};
var $author$project$Presentations$view = function (_v0) {
	var presentations = _v0.G;
	var viewPresentation = function (presentation) {
		return A2(
			$elm$html$Html$li,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							...
							$author$project$Presentation$url(presentation))
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(
							$author$project$Presentation$name(presentation))
						]))
				]));
	};
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$ul,
				_List_Nil,
				A2($elm$core$List$map, viewPresentation, presentations))
			]));
};
var $author$project$Presentations$main = function () {
	var model = {G: _List_Nil, aa: $elm$core$Maybe$Nothing};
	var cmd = $elm$http$Http$get(
		{
			aA: A2(
				$elm$http$Http$expectJson,
				$elm$core$Basics$identity,
				$elm$json$Json$Decode$list($author$project$Presentation$decoder)),
			ao: 'presentations.json'
		});
	return $elm$browser$Browser$element(
		{
			...
			aO: $author$project$Presentations$subscriptions,
			aR: $author$project$Presentations$update,
			aS: $author$project$Presentations$view
		});
}();
_Platform_export({'Presentations':{'init':$author$project$Presentations$main(
